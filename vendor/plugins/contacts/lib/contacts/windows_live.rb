  ...
  class WindowsLive
    ...
    def initialize(config_file=CONFIG_FILE)
      ...
      if Government.current and Government.current.attribute_present?("windows_appid")
        @wll = WindowsLiveLogin.new(Government.current.windows_appid, Government.current.windows_secret_key, confs['security_algorithm'],nil, 'http://' + Government.current.base_url + '/about/privacy', 'http://' + Government.current.misc_url + '/import/windows')        
      else
        @wll = WindowsLiveLogin.new(confs['appid'], confs['secret'], confs['security_algorithm'],nil, 'http://' + Government.current.base_url + '/about/privacy', 'http://' + Government.current.misc_url + '/import/windows')
      end      
    end
