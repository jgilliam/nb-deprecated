ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :obama_letters, :member => {:preview => :get}
  ...
  map.resources :signups, :endorsements, :passwords, :searches, :unsubscribes, :notifications, :governments, :pages, :about
